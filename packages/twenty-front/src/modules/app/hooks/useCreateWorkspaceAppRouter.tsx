...
const ChooseSubscriptionPlan = lazyWithPreload(() =>
  import('~/pages/onboarding/ChooseSubscriptionPlan').then((module) => ({
    default: module.ChooseSubscriptionPlan,
  })),
);

const SubscriptionPaymentSuccess = lazy(() =>
  import('~/pages/onboarding/SubscriptionPaymentSuccess').then((module) => ({
    default: module.SubscriptionPaymentSuccess,
  })),
);
...
const UserGuidePage = lazy(() =>
  import('~/pages/user-guide/UserGuidePage').then((module) => ({
    default: module.UserGuidePage,
  })),
);
    ...
    createRoutesFromElements(
      ...
      >
        ...
        <Route element={<AuthFlowLayout />}>
          ...
          />
          <Route
            path={AppPath.SubscriptionRequiredSuccess}
            element={
              <LazyRoute fallback={<OnboardingPageLoader />}>
        ...
        <Route element={<BlankLayout />}>
          ...
          >
            ...
            />
            <Route
              path={AppPath.SubscriptionRequired}
              element={
                <LazyRoute fallback={<OnboardingStepPageLoader />}>
