...
const SettingsSubscriptionBilling = lazy(() =>
  import('~/pages/settings/subscription-billing/SettingsSubscriptionBilling').then(
    (module) => ({
      default: module.SettingsSubscriptionBilling,
    }),
  ),
);
    ...
    <Routes>
      ...
      >
        ...
        <Route
          ...
          element={<SettingsSubscriptionBilling />}
        />
        <Route
