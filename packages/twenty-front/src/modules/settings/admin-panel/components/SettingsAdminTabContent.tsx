...
import { SettingsAdminSubscriptionBilling } from '@/settings/admin-panel/subscription-billing/components/SettingsAdminSubscriptionBilling';
import { SettingsAdminTenants } from '@/settings/admin-panel/subscription-billing/components/SettingsAdminTenants';
...
export const SettingsAdminTabContent = ({
  ...
  switch (activeTabId) {
    ...
    case SETTINGS_ADMIN_TABS.SUBSCRIPTION_BILLING:
      return <SettingsAdminSubscriptionBilling />;
