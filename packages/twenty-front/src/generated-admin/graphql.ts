...
export type MutationUpdateSeatPriceArgs = {
  input: UpdateSeatPriceInput;
};
...
export type Query = {
  ...
  adminTenantsOverview: Array<TenantOverview>;
  ...
  getCurrentSeatPrice?: Maybe<SeatPrice>;
...
export type SeatPrice = {
  ...
  currency: Scalars['String']['output'];
  firstPeriodUnitAmountCents?: Maybe<Scalars['Int']['output']>;
  interval: Scalars['String']['output'];
  isSyncedWithStripe: Scalars['Boolean']['output'];
  unitAmountCents: Scalars['Int']['output'];
};
...
export type TenantOverview = {
  ...
  displayName?: Maybe<Scalars['String']['output']>;
  estimatedMrrCents?: Maybe<Scalars['Int']['output']>;
  isGrandfathered: Scalars['Boolean']['output'];
...
export type UpdateSeatPriceInput = {
  currency?: InputMaybe<Scalars['String']['input']>;
  unitAmountCents: Scalars['Int']['input'];
};
...
export type UpdateSeatPriceMutationVariables = Exact<{
  input: UpdateSeatPriceInput;
}>;


export type UpdateSeatPriceMutation = { __typename?: 'Mutation', updateSeatPrice: { __typename?: 'SeatPrice', unitAmountCents: number, currency: string, interval: string, isSyncedWithStripe: boolean } };

export type AdminTenantsOverviewQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminTenantsOverviewQuery = { __typename?: 'Query', adminTenantsOverview: Array<{ __typename?: 'TenantOverview', workspaceId: string, displayName?: string | null, subdomain?: string | null, createdAt: string, subscriptionStatus?: string | null, seats: number, activeMembers: number, trialEnd?: string | null, currentPeriodEnd?: string | null, isGrandfathered: boolean, estimatedMrrCents?: number | null }> };

export type GetCurrentSeatPriceQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentSeatPriceQuery = { __typename?: 'Query', getCurrentSeatPrice?: { __typename?: 'SeatPrice', unitAmountCents: number, currency: string, interval: string, isSyncedWithStripe: boolean } | null };
...
export const UpdateSeatPriceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateSeatPrice"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateSeatPriceInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateSeatPrice"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unitAmountCents"}},{"kind":"Field","name":{"kind":"Name","value":"currency"}},{"kind":"Field","name":{"kind":"Name","value":"interval"}},{"kind":"Field","name":{"kind":"Name","value":"isSyncedWithStripe"}}]}}]}}]} as unknown as DocumentNode<UpdateSeatPriceMutation, UpdateSeatPriceMutationVariables>;
export const AdminTenantsOverviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminTenantsOverview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"adminTenantsOverview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workspaceId"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"subdomain"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"subscriptionStatus"}},{"kind":"Field","name":{"kind":"Name","value":"seats"}},{"kind":"Field","name":{"kind":"Name","value":"activeMembers"}},{"kind":"Field","name":{"kind":"Name","value":"trialEnd"}},{"kind":"Field","name":{"kind":"Name","value":"currentPeriodEnd"}},{"kind":"Field","name":{"kind":"Name","value":"isGrandfathered"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedMrrCents"}}]}}]}}]} as unknown as DocumentNode<AdminTenantsOverviewQuery, AdminTenantsOverviewQueryVariables>;
export const GetCurrentSeatPriceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCurrentSeatPrice"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCurrentSeatPrice"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unitAmountCents"}},{"kind":"Field","name":{"kind":"Name","value":"currency"}},{"kind":"Field","name":{"kind":"Name","value":"interval"}},{"kind":"Field","name":{"kind":"Name","value":"isSyncedWithStripe"}}]}}]}}]} as unknown as DocumentNode<GetCurrentSeatPriceQuery, GetCurrentSeatPriceQueryVariables>;