...
import { buildConversationMessageStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-conversation-message-standard-flat-field-metadata.util';
import { buildConversationParticipantStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-conversation-participant-standard-flat-field-metadata.util';
import { buildConversationStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-conversation-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  conversation: buildConversationStandardFlatFieldMetadatas,
  conversationMessage: buildConversationMessageStandardFlatFieldMetadatas,
  conversationParticipant:
    buildConversationParticipantStandardFlatFieldMetadatas,
