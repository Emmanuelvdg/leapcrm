...
export class UserSessionEntity {
  ...
  // The original real-credential login time this session's token chain
  // descends from — distinct from createdAt, which a silent refresh-token
  // renewal bumps to "now" every time a new row is inserted.
  @Column({ type: 'timestamptz' })
