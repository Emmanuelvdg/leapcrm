...
@RegisteredInstanceCommand('2.33.0', 1789782196246)
export class AddConversationsWidgetTypeFastInstanceCommand
  implements FastInstanceCommand
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DELETE FROM "core"."pageLayoutWidget" WHERE "type" = 'CONVERSATIONS'`,
    );
    await queryRunner.query(
