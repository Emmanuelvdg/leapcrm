...
import { AddSubscriptionBillingFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-instance-command-fast-1788061307082-add-subscription-billing';
import { AddAuthenticatedAtToUserSessionFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-instance-command-fast-1788281652686-add-authenticated-at-to-user-session';
...
export const INSTANCE_COMMANDS = [
  ...
  AddSubscriptionBillingFastInstanceCommand,
  AddAuthenticatedAtToUserSessionFastInstanceCommand,
